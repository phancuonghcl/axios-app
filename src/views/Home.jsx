...
const Home = () => {
    ...
    const find = () => {
        ...
        axios.get("http://lp-pf37ljch.geo.corp.hcl.in:8094/search",{
            params: {
                                ...
                                <div className="xp-searchbar">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <div className="input-group-append">
                                            <button type='button' className="btn" onClick={find} id="findbtn">GO</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="table-title">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                                            <a href="#addEmployeeModal"id='addEmpBtn' className="btn btn-success" data-toggle="modal">
